...
def train():
    ...
    ########   weights initialisation and standardisation
    ...
    ########   bias initialisation and standardisation
    ...
    file1 = open("/home/omkharat/Desktop/IvLabs/DeepLearning/train.csv", "r")
    train_images =file1.readlines()
    file1.close()

    file2 = open("/home/omkharat/Desktop/IvLabs/DeepLearning/test.csv", "r")
    test_images =file2.readlines()
    file2.close()
